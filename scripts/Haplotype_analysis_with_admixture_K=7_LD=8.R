...
ggsave(paste("plots/max_hap_sharing_genome_K=7_LD8_HI.png"), width = 3.5, height = 5)
ggsave(paste("plots/max_hap_sharing_genome_K=7_LD8_HI.pdf"), width = 3.5, height = 5)

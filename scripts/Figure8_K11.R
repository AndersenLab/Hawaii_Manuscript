...
###  Generate stats for continuous variables
  ...
  k12_box_plots
  ggsave('plots/Hawaiian_population_association_box_plots_K=11_LD=8_25mfiltered_FHgrouped.pdf', width = 7.5, height = 5, useDingbats = F)
...
#5 plot HI map file supplement  
  ...
  ggsave(world_plot, filename = "plots/K11_HW_MAP_Admix.pdf",
         height = 10,
         width = 10)
...
# 7 plot euro map
  ...
  ggsave(euro_plot, filename = "plots/K11_euro_MAP_Admix.pdf", useDingbats = F,
        height = 3,
        width = 3)
